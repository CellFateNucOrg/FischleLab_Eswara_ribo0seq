...
nextflow run nf-core/differentialabundance -profile rnaseq,singularity --input ${WORK_DIR}/samplesheet.csv --outdir $WORK_DIR -c $CONFIG_FILE \
	--gtf $gtfFile   \
	--matrix ${WORK_DIR}/star_salmon/salmon.merged.gene_counts.tsv \
